...
struct InsPiece {
  ...
  virtual gword_t build(unordered_map<string, gword_t> &values, gword_t &instruction) const = 0;
...
struct BoolPiece : public InsPiece {
  ...
  gword_t build(unordered_map<string, gword_t> &values, gword_t &instruction) const override {
